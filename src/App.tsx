...
function App() {
  return (
    <div className="App">
      ...
      <p>Every day there is a challenge in here. Sometimes also an inspiration that you can or cannot do. <br/>You can "open" the door earliest on the particular day by clicking on it. </p>
